            ...
            <div class="main-grid align-center">
                ...
                <script>
                    ...
                    function debt_as_html(debt, debtor) {
                        return "<tr><td class='row align-center justify-center'><div class='small-profile-picture'><img id='user-pfp-" + debtor + "' src='https://cdn.nathcat.net/pfps/default.png'></div><h4 id='user-" + debtor + "'>User " + debtor + "</h4></td><td><p>£" + debt + "</p></td></tr>";
                    }

                    function transaction_as_html(t) {
                        return "<tr><td class='row align-center justify-center'><div class='small-profile-picture'><img id='transaction-user-pfp-" + t.payer + "' src='https://cdn.nathcat.net/pfps/default.png'></div><h4 id='transaction-user-" + t.payer + "'></h4></td><td><p>" + t.amount + "</p></td><td><p>" + t.payeeCount + "</p></td><td><p>" + t.timestamp + "</p></td></tr>";
                    }
