            ...
            <div class="main-grid align-center">
                ...
                <script>
                    ...
                    function transaction_as_html(t) {
                        return "<div class='content-card row justify-center'><p id='transaction-user-" + t.payer + "'></p><span class='quarter-spacer'></span><p>paid " + t.amount + " to " + t.payeeCount + " people</p></div>"; 
                    }
